...
public class CampfireModifierRackEntityRenderer implements BlockEntityRenderer<CampfireModifierRackEntity> {
    private static final float itemSize = 0.3f;

    public CampfireModifierRackEntityRenderer(BlockEntityRendererFactory.Context context){
    }

    @Override
    public void render(CampfireModifierRackEntity entity, float tickDelta, MatrixStack matrices,
